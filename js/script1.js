...
// Funzione per analizzare il file XML e generare la tabella per il Canale1
function parseXML(xml) {
    var xmlDoc = xml.responseXML;
    var table = "<thead><tr><th>Ora Inizio</th><th>Ora Fine</th><th>Nome Programma</th><th>Preview</th></tr></thead>";

    var canale1 = xmlDoc.getElementsByTagName("Canale1")[0];
    var programmi = canale1.getElementsByTagName("Programma");
